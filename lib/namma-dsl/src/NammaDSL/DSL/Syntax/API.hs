...
data DashboardAuthType = DASHBOARD_USER | DASHBOARD_ADMIN | FLEET_OWNER | DASHBOARD_RELEASE_ADMIN | MERCHANT_ADMIN | MERCHANT_MAKER | MERCHANT_CHECKER | MERCHANT_SERVER | MERCHANT_USER | TICKET_DASHBOARD_USER | TICKET_DASHBOARD_ADMIN | TICKET_DASHBOARD_MERCHANT | TICKET_DASHBOARD_ONBOARDING_VERIFIER
  deriving (Show)
